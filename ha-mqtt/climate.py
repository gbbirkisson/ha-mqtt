...
class Climate(_Base):
    def __init__(self, climate_id, climate_name, thermometer, heat=None, cool=None, temp_formatter_func=temp_formatter,
    ...
    def send_update(self):
        ...
        # self._topic_state_curr_temp
        # self._topic_state_mode.
        # self._topic_state_curr_temp = state_topic
